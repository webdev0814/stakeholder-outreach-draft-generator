...
This document contains personalized email templates for the job search outreach. Each template is customized based on whether the recipient is a City Colleague (by agency) or a Vendor Partner (by firm).
...
*Use this for all other city agencies.*
...
* **Body**:
  ...
  I really valued working on the platform's agency integrations. I'm now looking for my next contract role. Do you happen to know if [Organization] has any active or upcoming contracts for a Senior BA, Agile PM, or RTE? 
...
## 🏢 Vendor Partner Templates

### 1. MTX Group
*Use this for MTX Group employees.*
...
*Use this for EY and Nuvalence employees.*
...
### 3. Deloitte
*Use this for Deloitte employees.*
...
*Use this for Maureen Data Systems employees.*
...
*Use this for all other vendors.*
